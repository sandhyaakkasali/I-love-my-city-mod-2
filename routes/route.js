...
exports.city=function(req,res){
    ...
    if(cityName === 'kolkata'){
       title="kolkata";
       heading ="kolkata, the capital of the Indian state of West Bengal. Located on the east bank of the Hooghly River, it is the principal commercial, cultural, and educational centre of East India, while the Port of Kolkata is India's oldest operating port and its sole major riverine port. }
